...
#define SI7020_SDA_IN()  do{GPIOB->MODER&=~(3<<(1*2));GPIOB->MODER|=(0<<(1*2));}while(0)	//PB7输入模式
#define SI7020_SDA_OUT() do{GPIOB->MODER&=~(3<<(1*2));GPIOB->MODER|=(1<<(1*2));}while(0)	//PB7输入模式
