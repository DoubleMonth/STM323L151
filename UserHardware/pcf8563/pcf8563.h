...
static void PCF8563_IIC_Start(void);				//发送IIC开始信号
static void PCF8563_IIC_Stop(void);	  			//发送IIC停止信号
static void PCF8563_IIC_Send_Byte(uint8_t txd);			//IIC发送一个字节
static uint8_t PCF8563_IIC_Read_Byte(unsigned char ack);//IIC读取一个字节
static uint8_t PCF8563_IIC_Wait_Ack(void); 				//IIC等待ACK信号
static void PCF8563_IIC_Ack(void);					//IIC发送ACK信号
static void PCF8563_IIC_NAck(void);				//IIC不发送ACK信号
